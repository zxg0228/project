var cals = document.getElementsByName("cal");
		...
		for(var i = 1;i < trs.length-1;i++){
			var rowPrice =trs[i].cells[4].innerHTML;
			var num = document.getElementsByName("num")[i-1];
			priceTotal.innerHTML = (parseFloat(priceTotal.innerHTML) + parseFloat(rowPrice)).toFixed(2);
			selectedTotal.innerHTML = parseInt(selectedTotal.innerHTML) + parseInt(num.value);
		}
